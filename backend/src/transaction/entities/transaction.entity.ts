import { Entity, Column, PrimaryGeneratedColumn, CreateDateColumn, UpdateDateColumn, OneToMany, ManyToOne, Index, JoinColumn } from 'typeorm';
...
export class Transaction {
    ...
    @Column({ type: 'enum', enum: TransactionStatus, default: TransactionStatus.UNPAID })
    status: TransactionStatus;

    @Column({ type: 'enum', enum: TransactionType, default: TransactionType.BILLIARD })
