    ...
    try {
      ...
      for (const ing of ingredientsData) {
        try {
          ...
          const match = existing.find(
            (i) => i.sku === ing.sku || i.name === ing.name,
          );
      ...
      for (const menu of menuData) {
        try {
          ...
          const match = existing.find(
            (m) => m.sku === menu.sku || m.name === menu.name,
          );
      ...
      const findIngId = (name: string) =>
        seededIngredients.find((i) => i.name === name)?.id;
      const findMenuId = (sku: string) =>
        seededMenuItems.find((m) => m.sku === sku)?.id;
      ...
      const recipes = [
        {
          m: 'MN-001',
          items: [
            { n: 'Beras Basmathi', q: 200, u: 'Gram' },
            { n: 'Telur Ayam', q: 1, u: 'Butir' },
            { n: 'Minyak Kelapa', q: 50, u: 'Ml' },
          ],
        },
        {
          m: 'MN-002',
          items: [
            { n: 'Beras Basmathi', q: 200, u: 'Gram' },
            { n: 'Udang Fresh', q: 50, u: 'Gram' },
            { n: 'Cumi-cumi', q: 50, u: 'Gram' },
          ],
        },
        {
          m: 'MN-009',
          items: [
            { n: 'Daging Sapi Sirloin', q: 150, u: 'Gram' },
            { n: 'Lada Hitam Bubuk', q: 5, u: 'Gram' },
            { n: 'Bawang Bombay', q: 50, u: 'Gram' },
          ],
        },
        {
          m: 'MN-014',
          items: [
            { n: 'Daging Giling', q: 100, u: 'Gram' },
            { n: 'Bun Burger', q: 1, u: 'Pcs' },
            { n: 'Keju Cheddar', q: 1, u: 'Pack' },
          ],
        },
        {
          m: 'MN-016',
          items: [
            { n: 'Pasta Spaghetti', q: 1, u: 'Pack' },
            { n: 'Daging Giling', q: 50, u: 'Gram' },
            { n: 'Tomat', q: 100, u: 'Gram' },
          ],
        },
        {
          m: 'MN-027',
          items: [
            { n: 'Biji Kopi Arabica', q: 18, u: 'Gram' },
            { n: 'Es Batu', q: 1, u: 'Bag' },
          ],
        },
        {
          ...
          items: [
            { n: 'Biji Kopi Arabica', q: 18, u: 'Gram' },
            { n: 'Susu UHT', q: 200, u: 'Ml' },
          ],
        },
        {
          m: 'MN-031',
          items: [
            { n: 'Biji Kopi Robusta', q: 18, u: 'Gram' },
            { n: 'Susu UHT', q: 100, u: 'Ml' },
            { n: 'Gula Aren', q: 20, u: 'Ml' },
          ],
        },
        {
          m: 'MN-042',
          items: [
            { n: 'Alpukat', q: 200, u: 'Gram' },
            { n: 'Susu Kental Manis', q: 50, u: 'Ml' },
            { n: 'Es Batu', q: 0.5, u: 'Bag' },
          ],
        },
      ];
