...
if "!LOCATION_NAME!"=="" (
    echo.
    set /p "LOCATION_NAME=  Masukkan Nama Lokasi (contoh: scuff Surabaya): "
    echo.
)
...
:: Pastikan MACHINE_ID ada di .env (bisa tidak ada di instalasi lama)
findstr /i "MACHINE_ID=" "!INSTALL_DIR!.env" >nul 2>&1
if errorlevel 1 (
    echo  [..] MACHINE_ID belum ada di .env, menambahkan...
    echo MACHINE_ID=!MACHINE_ID!>> "!INSTALL_DIR!.env"
    echo LICENSE_KEY=>> "!INSTALL_DIR!.env"
    echo  [OK] MACHINE_ID ditambahkan: !MACHINE_ID!
)
...
echo    Akses Online    : https://scuff.vocbilliard.online
echo  ============================================================
echo.
echo    Lokasi    : !LOCATION_NAME!
