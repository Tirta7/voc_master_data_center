export const PERMISSION_GROUPS = [
    ...
    },
    {
        ...
        permissions: [
            ...
            { id: 'INVENTORY_WASTE', label: 'Deklarasi Waste / Pembuangan' },
            { id: 'INV_ADD_ITEM', label: 'Tambah Bahan Baku Baru' },
            { id: 'INVENTORY_STOCK_IN', label: 'Penerimaan / Tambah Stok (+)' },
            { id: 'INVENTORY_STOCK_OUT', label: 'Pemakaian / Kurangi Stok (-)' },
            { id: 'INVENTORY_RECEIVE', label: 'Terima Barang (Purchase/Restock)' },
            { id: 'INV_EDIT_ITEM', label: 'Edit Detail Bahan Baku' },
            { id: 'INV_DELETE_ITEM', label: 'Hapus Bahan Baku' },
            { id: 'INV_RECIPE', label: 'Kelola Formula Resep' },
            { id: 'INV_ADD_MENU', label: 'Tambah Menu Baru' },
            { id: 'INV_EDIT_MENU', label: 'Edit Detail Menu' },
            { id: 'INV_DELETE_MENU', label: 'Hapus Menu' },
            { id: 'INV_TOGGLE_MENU', label: 'Aktif / Non-Aktifkan Menu' },
    ...
    },
    {
        ...
        permissions: [
            ...
            { id: 'USER_EDIT', label: 'Edit Profil & Data Karyawan' },
            { id: 'USER_DELETE', label: 'Hapus Data Karyawan' },
            { id: 'USER_VIOLATION', label: 'Input Pelanggaran (Log Violation)' },
    ...
    },
    {
        ...
        permissions: [
            ...
            { id: 'SETTING_APPROVAL', label: 'Atur Approval Matrix (Delegasi)' },
            { id: 'SETTING_HARDWARE', label: 'Konfigurasi IoT, IP & Printer' },
            { id: 'SETTING_FIRMWARE', label: 'Update Firmware OTA ESP32' },
            { id: 'SETTING_INVOICE', label: 'Kustomisasi Invoice' },
            { id: 'SETTING_DATABASE', label: 'Maintenance & Pembersihan DB' },
            { id: 'SETTING_WHATSAPP', label: 'Integrasi WhatsApp Gateway' },
            { id: 'SETTING_LICENSE', label: 'Status & Perpanjang Lisensi' },
            { id: 'SETTING_TABLES', label: 'Akses Halaman Manajemen Meja' },
