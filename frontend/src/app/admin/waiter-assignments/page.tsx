    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] p-6 lg:p-10 space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="space-y-2">
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-50 text-indigo-600 rounded-full border border-indigo-100">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-wider">Access Control</span>
                    </div>
                    <h1 className="text-3xl lg:text-5xl font-black text-slate-900 tracking-tight leading-tight">
                        PENUGASAN <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-violet-600">WAITER</span>
                    </h1>
                    <p className="text-slate-500 font-medium text-sm lg:text-base max-w-2xl">
                        Atur area kerja waiter secara real-time. Waiter hanya akan melihat meja yang telah Anda tugaskan.
                    </p>
                </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                <div className="bg-white p-5 lg:p-6 rounded-[2rem] border border-slate-200 shadow-sm hover:shadow-md transition-all group">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Shift Aktif</p>
                            <p className="text-2xl font-black text-slate-900 leading-none">{shifts.length}</p>
                        </div>
                    </div>
                </div>
                <div className="bg-indigo-900 p-5 lg:p-6 rounded-[2rem] border border-indigo-800 shadow-xl shadow-indigo-200/50 group relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-4 relative z-10">
                        ...
                        <div>
                            <p className="text-[10px] font-black text-indigo-300 uppercase tracking-widest leading-none mb-1">Total Meja Cafe</p>
                            <p className="text-2xl font-black text-white leading-none">{cafeTables.length}</p>
                        </div>
                    </div>
                </div>
                <div className="bg-slate-900 p-5 lg:p-6 rounded-[2rem] border border-slate-800 shadow-xl shadow-slate-200/50 group relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-24 h-24 bg-indigo-500/10 rounded-full -mr-10 -mt-10 blur-2xl" />
                    <div className="flex items-center gap-4 relative z-10">
                        <div className="w-12 h-12 bg-white/10 rounded-2xl flex items-center justify-center text-indigo-400">
                            <Gamepad2 className="w-6 h-6" />
                        </div>
                        <div>
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Total Billiard</p>
                            <p className="text-2xl font-black text-white leading-none">{billiardTables.length}</p>
                        </div>
                    </div>
                </div>
                <div className="bg-white p-5 lg:p-6 rounded-[2rem] border border-slate-200 shadow-sm hover:shadow-md transition-all group">
                    <div className="flex items-center gap-4 text-emerald-600">
                        ...
                        <div>
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Cakupan Area</p>
                            <p className="text-2xl font-black text-slate-900 leading-none">
                                {Math.round((shifts.reduce((acc, s) => acc + (s.assignedTableIds?.length || 0), 0) / (cafeTables.length + billiardTables.length || 1)) * 100)}%
                            </p>
                        </div>
                    </div>
                </div>
