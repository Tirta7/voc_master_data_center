                  ...
                  return (
                    ...
                    >
                      <div className="relative mb-4">
                        ...
                        <div
                          className={`w-20 h-20 rounded-[2rem] border-2 flex items-center justify-center font-black text-2xl transition-all duration-500 shadow-sm ${
                            emp.status === "ACTIVE"
                        ...
                        >
                          ...
                          <div
                            className={`absolute -bottom-1 -right-1 w-7 h-7 rounded-full border-[3px] border-white flex items-center justify-center shadow-md ${
                              emp.status === "ACTIVE"
                                ? "bg-emerald-500"
                                : emp.status === "AWAY"
                                  ? "bg-amber-500"
                      ...
                      <div className="text-center w-full px-2">
                        ...
                        <div className="flex flex-col items-center gap-1">
                          <div
                            className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full border transition-all duration-300 ${
                              emp.status === "ACTIVE"
