...
> **Spot On Billiard** | Hybrid MQTT + ESP-NOW | Versi 3 — SmartDeploy
...
```
╔══════════════════════════════════════════════════════════════╗
║  LAPIS 1 — BOOT VALIDATION (saat Prajurit restart)          ║
╠══════════════════════════════════════════════════════════════╣
║  Cache SPIFFS ada → kirim 3 probe ke Komandan               ║
║  • Berhasil → pakai channel itu (boot < 1 detik)            ║
║  • Gagal    → hapus cache → full hopping Ch.1..13          ║
║                                                              ║
║  🎯 Handles: router restart, Prajurit restart               ║
╠══════════════════════════════════════════════════════════════╣
║  LAPIS 2 — BEACON MONITORING (real-time, tanpa restart)     ║
╠══════════════════════════════════════════════════════════════╣
║  Komandan broadcast beacon setiap 30 detik berisi:          ║
║    { type:0xBC, channel:11, floorId:1 }                     ║
║  Prajurit terima → channel berbeda dari cache?              ║
║  → switchChannel() LANGSUNG tanpa restart!                  ║
║  → Update cache SPIFFS                                       ║
║                                                              ║
║  🎯 Handles: router ganti channel saat runtime              ║
║  ⏱ Downtime maksimal: 0–30 detik                            ║
╠══════════════════════════════════════════════════════════════╣
║  LAPIS 3 — AUTO-RESYNC (jaring pengaman akhir)              ║
╠══════════════════════════════════════════════════════════════╣
║  3 menit tanpa sinyal Komandan:                             ║
║  → Hapus cache → full channel hopping → simpan baru         ║
║                                                              ║
║  🎯 Handles: kasus ekstrem (sinyal lemah, interferensi)     ║
...
*Dokumen ini dibuat otomatis oleh sistem VOC Billiard. Versi: 2026-04-15 v3*
