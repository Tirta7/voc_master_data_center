            ...
            <AnimatePresence>
                {isOvertime && !showModal && (
                    <motion.div
                        ...
                        className="fixed top-24 right-4 z-[90] lg:right-8 bg-amber-500/10 border border-amber-500/30 shadow-lg backdrop-blur-md px-3 py-2 rounded-xl flex items-center gap-2 cursor-pointer hover:bg-amber-500/20 transition-colors"
                        onClick={() => {
