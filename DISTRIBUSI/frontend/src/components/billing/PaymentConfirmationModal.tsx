...
import { Printer, CheckCircle, CheckCircle2, X, CreditCard, PartyPopper } from 'lucide-react';
...
export default function PaymentConfirmationModal({ isOpen, onClose, onConfirm, onPrint, onDone, data, isLoading, isPaid }: PaymentConfirmationModalProps) {
                    ...
                    <>
                        ...
                        <div className="bg-emerald-50 p-6 border-b border-emerald-100 flex justify-between items-center">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-lg font-black text-emerald-700 uppercase tracking-wide">Pembayaran Sukses!</h3>
                            </div>
                        </div>
                        ...
                        <div className="p-8">
                            {/* Summary Sukses */}
                            <div className="bg-emerald-50 rounded-2xl p-5 border border-emerald-100 space-y-4 mb-6">
                                <div className="flex justify-between items-end">
                                    <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Total Dibayar</span>
                                ...
                                {data.change > 0 && (
                                    <div className="bg-emerald-100 p-3 rounded-xl flex justify-between items-center border border-emerald-200">
                                        <span className="text-xs font-bold text-emerald-700 uppercase tracking-wider">Kembalian</span>
                            ...
                            <p className="text-center text-sm text-slate-400 font-medium mb-8">
                                Silakan cetak struk untuk pelanggan, lalu tekan Selesai.
                            </p>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <button
                                    onClick={onPrint}
                                    className="col-span-2 py-4 rounded-xl bg-indigo-600 text-white font-black hover:bg-indigo-700 shadow-lg shadow-indigo-200 transition-all active:scale-95 flex items-center justify-center gap-2 uppercase tracking-wider text-xs"
                                >
                                ...
                                <button
                                    onClick={onDone}
                                    className="col-span-2 py-4 rounded-xl border-2 border-emerald-200 text-emerald-600 font-bold hover:bg-emerald-50 transition-all uppercase tracking-wider text-xs flex items-center justify-center gap-2"
                                >
